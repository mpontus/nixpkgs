...
*** COMMENT Private Internet Access

#+begin_src nix :noweb-ref overlays
  (self: super: {
    piavpn = super.callPackage ./pkgs/piavpn { };
  })
#+end_src
...
Follow Nixpkgs unstable channel
...
** TODO Permit legacy nodejs for now
...
tilda  deluge pavucontrol tdesktop slack vscode obsidian vlc
  obs-studio element-desktop postman alacritty tabbed yakuake tilix
...
#+begin_src nix :noweb-ref home-packages
  awscli2 cmake git gnupg hub imagemagick jq ledger libtool  pass unzip pandoc  nixfmt
...
Programs for monitoring and diagnosing the system
...
Various programs for navigating the filesytem

#+begin_src nix :noweb-ref home-packages
file tree ripgrep silver-searcher fd ncdu
#+end_src
